...
@property (NS_NONATOMIC_IOSONLY, readonly) int64_t lastInsertRowId;
...
@property (NS_NONATOMIC_IOSONLY, readonly) void *sqliteHandle;
...
@property (NS_NONATOMIC_IOSONLY) NSTimeInterval maxBusyRetryTimeInterval;
