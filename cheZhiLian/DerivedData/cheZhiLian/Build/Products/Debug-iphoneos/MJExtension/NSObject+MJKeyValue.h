 ...
 *  @return 字典
 */
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSMutableDictionary *mj_keyValues;
 ...
 *  转换为JSON Data
 */
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSData *mj_JSONData;
/**
 *  转换为字典或者数组
 */
@property (NS_NONATOMIC_IOSONLY, readonly, strong) id mj_JSONObject;
/**
 *  转换为JSON 字符串
 */
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *mj_JSONString;
@end
